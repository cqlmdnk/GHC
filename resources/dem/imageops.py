...
## flip a sprite file
im = Image.open("C:/Users/bbari/source/repos/cqlmdnk/GHC/resources/bg/1.bmp")
# imageS = Image.new("RGB", (im.width,im.height))
# dst = Image.new("RGB", (int(im.width/8),im.height))
# for i in range(8):
#     dst = im.crop(((int(im.width / 8)) * i, 0, (int(im.width / 8)) * (i + 1),
#                     im.height))
#     dst = ImageOps.mirror(dst)
#     imageS.paste(dst, (int((im.width / 8) * i), 0))
imageS = im.convert("P")
imageS.save("C:/Users/bbari/source/repos/cqlmdnk/GHC/resources/bg/1b.bmp")
